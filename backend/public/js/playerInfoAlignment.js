...
function checkChange(e) {
    ...
    if (e.target.checked && isRenkei[Number(e.target.name)].innerText == "連携待ち") {
        splitData[Number(e.target.name)] = 1;
    } else if (e.target.checked && isRenkei[Number(e.target.name)].innerText == "連携可能") {
