...
<body>
    ...
    <div class="container-fluid bootstrap snippets bootdey">
        ...
        <div style="background: linear-gradient(to right,#1991FC,  #45b796); color:#fff;padding-top:15px;">
            ...
            @else
            <h1 style="display: inline;margin-left:25%" class="text-right col-md-9">[種目名]</h1>
            @endif
        </div>
                ...
                <div class="col-md-8 offset-md-1">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr class="table-primary">
                                    <th colspan="5" class="text-center">レース結果</th>
                                </tr>
                            </thead>
                            <thead>
                                <tr>
                    ...
                    <div class="form-group row" style="padding: 2rem">
                        ...
                        <div class="col-sm-2">
                            ...
                            <button class="btn btn-danger btn-lg btn-block">クルー表示テスト用</button>
                        </div>
                    </div>
                    @dd($TournamentData,$RaceData,$RaceResultData,$pagemode,session()->get('pagemode'),session()->get('RaceResultData'))
