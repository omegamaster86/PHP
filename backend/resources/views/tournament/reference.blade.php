            ...
            <div class="row" style="padding:10px 0px;width: 100%;">
                <div class="col-md-8 offset-md-1">
                    ...
                    <div class="form-group">
                        <label class="col-md-6" style="text-align: right"><b>大会ID：</b></label>
                        <label for="entrysystem_org_id">XXXXXXXX</label>
                        <label class="col-md-6" style="text-align: right"><b>エントリーシステムの大会ID：</b></label>
                        <label for="entrysystem_org_id">XXXXXXXX</label>
                        <label class="col-md-6" style="text-align: right"><b>大会名：</b></label>
                        ...
                        <label class="col-md-6" style="text-align: right"><b>大会個別URL：</b></label>
