    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            <div style="text-align: right;">
                ...
                <x-input-label for="user_name" :value="__('ユーザー名')" onclick="details ('userInfo')" style="display: inline;" />
                <i onclick="details('userInfo')" class="fa fa-question-circle " aria-hidden="true"></i>
                <input style="display: inline; width:55%; margin-left: 2%;" id="user_name" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm mt-1 " type="text" maxLength="32" name="user_name" value="{{old('user_name')}}"  />
            </div>
        ...
        <div class="mt-4" >
            <div style="text-align: right;">
                <x-input-label onclick="details('emailInfo')" for="mailaddress" :value="__('メールアドレス')" style="display: inline;" />
                <i onclick="details('emailInfo')" class="fa fa-question-circle" aria-hidden="true"></i>
                <x-text-input id="mailaddress" style="display: inline; width:55%; margin-left: 2%" class="mt-1 "
        ...
        <div class="mt-4" >
            <div style="text-align: right;">
                <x-input-label style="display: inline;" for="confirm_email"
        ...
        <div style="margin: 5px 0px 10px 0px; text-align:center ">
            ...
            <label for="link-checkbox" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">利用規約に同意する</label>
        </div>
