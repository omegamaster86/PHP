{{--*************************************************************************
* Project name: JARA
* File name: entry-register.blade.php
* File extension: .blade.php
* Description: This is the ui of tournament entry register page
*************************************************************************
...
<head>
    ...
    <title>Tournament entry register</title>
...
<body>
    ...
    <div class="container-fluid bootstrap snippets bootdey">
        ...
        <div>
            ...
            <form method="post" action="{{ route('tournament-entry-register') }}" enctype="multipart/form-data" >
                @csrf
                <div class="col-md-12" style="display: flex">
                    <div class="col-md-3"></div>
                    <div class="col-md-6" style="background-color:#005BFC;padding-top:15px; border-radius: 10px ; color:#fff">
                        <div class="form-group"  >
                            <label class="control-label" for = "tournamentYear">大会開催年</label>
                            <div  style="display: flex">
                                <input id="tournamentYear" name="tournament_year" class="form-control " type="text" value="{{old('tournament_year')?old('tournament_year'):date('Y')}}"><label class=" control-label" for = "tournamentYear">年</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class=" control-label" for = "tournamentName">大会名</label>
                            <select id="tournamentName" name="tournament_name" class="form-control" >
                                <option value="" >--</option>
                                @foreach($tournament_name_list as $tournament)
                                <option value= {{$tournament->tourn_name}} {{ (old('tournament_name')===$tournament->tourn_name) ? "selected" : ""}} >{{$tournament->tourn_name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <p> ＊読み込みCSVファイル</p>
    ...
    <script src="{{ asset('js/tournamentEntryRegister.js') }}"></script>
    <script>
