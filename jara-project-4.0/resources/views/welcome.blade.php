    ...
    <div
        ...
        <div class="sm:fixed sm:top-50% sm:right-40% p-6 text-right z-10">
            ...
            <a href="{{ route('register') }}"
                class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">仮登録</a>
            @endif
            @endauth
        </div>
        @endif
