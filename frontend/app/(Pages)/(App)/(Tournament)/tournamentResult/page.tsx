...
//     setRaceResultRecords((prevFormData) => {
//       const newFormData = [...prevFormData];
//       newFormData[index].crewPlayer[crewIndex][name] = value;
//       return newFormData;
//     });
//   };
...
//      * 「半角数字で入力してください。」
//      */
//     const windSpeed = raceResultRecordResponse.tenHundredmWindSpeed;
...
//      * 「半角数字で入力してください。」
//      */
//     const windSpeed2 = raceResultRecordResponse.twentyHundredmWindSpeed;
...
//         if (i !== j && record.orgId === record2.orgId && record.crewName === record2.crewName) {
//           indexList9.push(i);
//           indexList9.push(j);
//         }
//         return i !== j && record.orgId === record2.orgId && record.crewName === record2.crewName;
//       });
//     });
//     if (isError7) {
...
//       // エラーに該当するレース結果情報のインデックスを取得する
//       if (
//         !record.fiveHundredmLaptime &&
//         !record.tenHundredmLaptime &&
//         !record.fifteenHundredmLaptime &&
...
//       if (
//         record.fiveHundredmLaptime &&
//         !/^\d{1,2}:\d{2}\.\d{2}$/.test(record?.fiveHundredmLaptime.toString())
//       ) {
//         indexList4.push(i);
//       }
//       return (
...
//       if (
//         record.tenHundredmLaptime &&
//         !/^\d{1,2}:\d{2}\.\d{2}$/.test(record?.tenHundredmLaptime.toString())
//       ) {
//         indexList5.push(i);
//       }
//       return (
...
//       if (
//         record.fifteenHundredmLaptime &&
//         !/^\d{1,2}:\d{2}\.\d{2}$/.test(record?.fifteenHundredmLaptime.toString())
//       ) {
//         indexList6.push(i);
//       }
//       return (
...
//       if (
//         record.twentyHundredmLaptime &&
//         !/^\d{1,2}:\d{2}\.\d{2}$/.test(record?.twentyHundredmLaptime.toString())
//       ) {
//         indexList7.push(i);
//       }
//       return (
...
//       // このページのみのバリデーションのため、ここにバリデーションロジックを記述
//       if (record.finalTime && !/^\d{1,2}:\d{2}\.\d{2}$/.test(record?.finalTime.toString())) {
//         indexList8.push(i);
//       }
//       return record.finalTime && !/^\d{1,2}:\d{2}\.\d{2}$/.test(record?.finalTime.toString());
//     });
//     if (lapTime6) {
//       indexList8.map((index) => {
//         handleRaceResultRecordsInputChangebyIndex(
...
//       // このページのみのバリデーションのため、ここにバリデーションロジックを記述
//       if (
//         record.fiveHundredmStrokeRat &&
//         !/^\d{1,2}$/.test(record?.fiveHundredmStrokeRat.toString())
//       ) {
//         indexList9.push(i);
//       }
//       return (
//         record.fiveHundredmStrokeRat && !/^\d{1,2}$/.test(record?.fiveHundredmStrokeRat.toString())
//       );
//     });
//     if (strokeRate) {
//       indexList9.map((index) => {
...
//       // このページのみのバリデーションのため、ここにバリデーションロジックを記述
//       if (
//         record.tenHundredmStrokeRat &&
//         !/^\d{1,2}$/.test(record?.tenHundredmStrokeRat.toString())
//       ) {
//         indexList10.push(i);
//       }
//       return (
//         record.tenHundredmStrokeRat && !/^\d{1,2}$/.test(record?.tenHundredmStrokeRat.toString())
//       );
//     });
//     if (strokeRate2) {
//       indexList10.map((index) => {
...
//       // このページのみのバリデーションのため、ここにバリデーションロジックを記述
//       if (
//         record.fifteenHundredmStrokeRat &&
//         !/^\d{1,2}$/.test(record?.fifteenHundredmStrokeRat.toString())
//       ) {
//         indexList11.push(i);
//       }
//       return (
...
//       // このページのみのバリデーションのため、ここにバリデーションロジックを記述
//       if (
//         record.twentyHundredmStrokeRat &&
//         !/^\d{1,2}$/.test(record?.twentyHundredmStrokeRat.toString())
//       ) {
//         indexList12.push(i);
//       }
//       return (
...
//       // このページのみのバリデーションのため、ここにバリデーションロジックを記述
//       if (record.strokeRateAvg && !/^\d{1,2}$/.test(record?.strokeRateAvg.toString())) {
//         indexList13.push(i);
//       }
//       return record.strokeRateAvg && !/^\d{1,2}$/.test(record?.strokeRateAvg.toString());
//     });
//     if (strokeRate5) {
...
//                     : raceResultRecordResponse?.tenHundredmWindDirection?.toString() || ''
//                 }
...
//             <CustomTextField
//               label='1000m地点風速'
//               value={raceResultRecordResponse?.tenHundredmWindSpeed?.toString() || ''}
//               displayHelp={false}
//               type='number'
//               inputAdorment='m/秒'
//               onChange={(e) => {
...
//                     : raceResultRecordResponse?.twentyHundredmWindDirection?.toString() || ''
//                 }
//                 options={windDirectionOptions.map((item) => ({
//                   key: item.id,
//                   value: item.name,
...
//             <CustomTextField
//               label='2000m地点風速'
//               value={raceResultRecordResponse?.twentyHundredmWindSpeed?.toString() || ''}
//               displayHelp={false}
//               type='number'
//               inputAdorment='m/秒'
//               onChange={(e) => {
...
//               <div
//                 onClick={() => {
//                   handleRaceResultRecordsInputChangebyIndex(index, 'deleteFlg', !item.deleteFlg);
//                 }}
...
//                     />
//                     <CustomDropdown
//                       value={mode === 'confirm' ? item?.orgName : item?.orgId?.toString() || ''}
...
//                         <CustomTextField
//                           label='500m'
//                           value={item?.fiveHundredmLaptime?.toString() || ''}
//                           displayHelp={false}
//                           onChange={(e) => {
//                             handleRaceResultRecordsInputChangebyIndex(
//                               index,
...
//                         <CustomTextField
//                           label='1000m'
//                           value={item.tenHundredmLaptime?.toString() || ''}
//                           displayHelp={false}
//                           onChange={(e) => {
//                             handleRaceResultRecordsInputChangebyIndex(
//                               index,
...
//                         <CustomTextField
//                           label='1500m'
//                           value={item.fifteenHundredmLaptime?.toString() || ''}
//                           displayHelp={false}
//                           onChange={(e) => {
//                             handleRaceResultRecordsInputChangebyIndex(
//                               index,
...
//                         <CustomTextField
//                           label='2000m'
//                           value={item.twentyHundredmLaptime?.toString() || ''}
//                           displayHelp={false}
//                           onChange={(e) => {
//                             handleRaceResultRecordsInputChangebyIndex(
//                               index,
...
//                         <CustomTextField
//                           label='500m'
//                           value={item?.fiveHundredmStrokeRat?.toString() || ''}
//                           type='number'
//                           displayHelp={false}
//                           inputAdorment='回/分'
//                           onChange={(e) => {
...
//                         <CustomTextField
//                           label='1000m'
//                           value={item?.tenHundredmStrokeRat?.toString() || ''}
//                           displayHelp={false}
//                           type='number'
//                           inputAdorment='回/分'
//                           onChange={(e) => {
...
//                         <CustomTextField
//                           label='1500m'
//                           value={item?.fifteenHundredmStrokeRat?.toString() || ''}
//                           displayHelp={false}
//                           type='number'
//                           inputAdorment='回/分'
//                           onChange={(e) => {
...
//                         <CustomTextField
//                           label='2000m'
//                           value={item?.twentyHundredmStrokeRat?.toString() || ''}
//                           displayHelp={false}
//                           type='number'
//                           inputAdorment='回/分'
//                           onChange={(e) => {
...
//                         <CustomTextField
//                           label='平均'
//                           value={item?.strokeRateAvg?.toString() || ''}
//                           displayHelp={false}
//                           type='number'
//                           inputAdorment='回/分'
//                           onChange={(e) => {
